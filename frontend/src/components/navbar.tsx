    ...
    const checkAuth = async () => {
      try {
        const response = await fetch(
          `${import.meta.env.VITE_HOST}/api/users/getUser`,
          {
            method: "GET",
            credentials: "include",
          }
      ...
      <div className="container mx-auto md:flex md:items-center">
        ...
        <div className="hidden md:flex md:w-2/3 md:justify-end">
          <ul className="flex items-center p-3 space-x-6 md:text-xl">
            {["Home", "About", "Innovations", "Projects", "Contact"].map(
              (item, i) => (
                <motion.li
                  key={item}
            ...
            {isLoggedIn ? (
              ...
              <Link to="/profile">
                  ...
                  >
                    <Button
                      variant="secondary"
                      className="mx-2 bg-purple-700 hover:bg-purple-800"
                    >
                      Profile
                    </Button>
                  </motion.div>
              ...
              <>
                ...
                <Link to="/signup">
                  ...
                  >
                    <Button
                      variant="outline"
                      className="mx-2 border-purple-500 text-white hover:bg-purple-800"
                    >
                      Sign Up
                    </Button>
                  </motion.div>
